...
public class ChatAttachmentPreviewAdapter extends BaseListAdapter<File> {
    public static final String TAG = ChatAttachmentPreviewAdapter.class.getSimpleName();
    ...
    public ChatAttachmentPreviewAdapter(Context context,
...
//        Glide.with(SimWeChatApplication.getInstance())
//                .load(attachmentFile)
