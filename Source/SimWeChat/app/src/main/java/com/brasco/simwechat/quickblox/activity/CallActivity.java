...
import com.brasco.simwechat.quickblox.fragments.AudioConversationFragment;
import com.brasco.simwechat.quickblox.fragments.BaseConversationFragment;
import com.brasco.simwechat.quickblox.fragments.ConversationFragmentCallbackListener;
import com.brasco.simwechat.quickblox.fragments.IncomeCallFragment;
import com.brasco.simwechat.quickblox.fragments.IncomeCallFragmentCallbackListener;
import com.brasco.simwechat.quickblox.fragments.OnCallEventsController;
import com.brasco.simwechat.quickblox.fragments.VideoConversationFragment;
...
import com.brasco.simwechat.utils.FragmentExecuotr;
...
public class CallActivity extends BaseActivity implements QBRTCClientSessionCallbacks
    ...
    public static void start(Context context,
        ...
        intent.putExtra(Constant.EXTRA_IS_INCOMING_CALL, isIncomingCall);
...
//            we have already currentSession == null, so it's no reason to do further initialization
    ...
    private void checkPermission() {
        if (checker.lacksPermissions(Constant.PERMISSIONS)) {
            startPermissionsActivity(!isVideoCall);
        }
    }

    private void startPermissionsActivity(boolean checkOnlyAudio) {
        //PermissionsActivity.startActivity(this, checkOnlyAudio, Constant.PERMISSIONS);
    }
    ...
    private void parseIntentExtras() {
        isInCommingCall = getIntent().getExtras().getBoolean(Constant.EXTRA_IS_INCOMING_CALL);
    }
...
//            audioManager.setDefaultAudioDevice(AppRTCAudioManager.AudioDevice.SPEAKER_PHONE);
    ...
    private void initQBRTCClient() {
        ...
        // Configure
        //
        QBRTCConfig.setMaxOpponentsCount(Constant.MAX_OPPONENTS_COUNT);
    ...
    public void onConnectionClosedForUser(QBRTCSession session, Integer userID) {
        ...
        if (hangUpReason != null && hangUpReason.equals(Constant.WIFI_DISABLED)) {
            Intent returnIntent = new Intent();
            setResult(Constant.CALL_ACTIVITY_CLOSE_WIFI_DISABLED, returnIntent);
            finish();
        }
    }
