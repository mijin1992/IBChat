...
import com.brasco.simwechat.quickblox.core.async.BaseAsyncTask;
...
import com.brasco.simwechat.quickblox.core.utils.constant.SchemeType;
...
public class GetFilepathFromUriTask extends BaseAsyncTask<Intent, Void, File> {
    public static final String TAG = GetFilepathFromUriTask.class.getSimpleName();
